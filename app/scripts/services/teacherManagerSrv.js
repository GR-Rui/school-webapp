...
//  var existingSession = LocalSessionService.getValidSession();
  ...
  return {
    ...
    updateTeacher: function (id, data) {
      var jsonStr = JSON.stringify(data);
      return $http
        .post(ConfigConst.urls.api + 'UpdateTeacher?info=' + jsonStr, data, {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
    ...
    deleteTeacher: function (id) {
      return $http
        .post(ConfigConst.urls.api + 'DeleteTeacherById?id=' + id, {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
    ...
    // get Available Teachers by school id
    getTeachersBySchoolId: function (schoolId) {
      return $http
        .get(ConfigConst.urls.api + 'GetTeacherPager/?schoolID=' + schoolId, {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
