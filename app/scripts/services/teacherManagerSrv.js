...
//  var existingSession = LocalSessionService.getValidSession();
  ...
  return {
    ...
    deleteTeacher: function (id) {
      return $http
        .delete(ConfigConst.urls.api + 'deleteTeacher?info=' + id, {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
    ...
    getTeacherById: function (id) {
      return $http
        .get(ConfigConst.urls.api + 'OneTeacher?info=' + id, {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
    ...
    getAllTeachers: function () {
      return $http
        .get(ConfigConst.urls.api + 'AllTeacher?info=', {headers: {}})
        .then(function (res) {
          return res.data;
        }, function (err) {
          return err;
