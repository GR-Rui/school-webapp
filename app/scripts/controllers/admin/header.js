 ...
 */
Site.controller('HeaderCtrl', ['$scope', 'AuthSrv', '$state', '$filter', 'SchoolManagerSrv', 'StudentManagerSrv', 'TeacherManagerSrv', 'TextbookManagerSrv', 'TextbookSectionManagerSrv', 'VideoManagerSrv', 'ClassManagerSrv',
  function ($scope, AuthSrv, $state, $filter, SchoolManagerSrv, StudentManagerSrv, TeacherManagerSrv, TextbookManagerSrv, TextbookSectionManagerSrv, VideoManagerSrv, ClassManagerSrv) {
    ...
    $scope.headerArray = [
      ...
      },
      {
        name: "教师关联管理",
        subList: [
          {name: "教师－班级关联管理", link: "admin.teacher-class-list"},
          {name: "教师－班级关联添加", link: "admin.teacher-class-add"},
          {name: "教师－教材关联管理", link: "admin.teacher-textbook-list"},
          {name: "教师－教材关联添加", link: "admin.teacher-textbook-add"}
        ]
      },
      {
        name: "教学管理",
    ...
    ClassManagerSrv.getAvailableClasses()
      .then(function (res) {
        var temp = JSON.parse(res);
        $scope.availableClasses = JSON.parse(temp);
      });
    ...
    $scope.availableTeachers = [
      {id: 1, real_name: '111111', desc: '111111'},
      {id: 2, real_name: '222222', desc: '111111'},
      {id: 3, real_name: '3333333', desc: '111111'}
    ];
